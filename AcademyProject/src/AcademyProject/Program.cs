...
namespace AcademyProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                academy.AddStudentsToAcademy();
                academy.AddStudent();

                do
                {
                    Console.WriteLine("Enter student id and course id ,separated by //");
                    studentsIds = Console.ReadLine();
                    academy.SignUp(studentsIds);
                } while (studentsIds != "quit");
